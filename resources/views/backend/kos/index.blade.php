                ...
                <form action="{{route('kos.update', $kos->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="{{$kos->nama}}" name="nama"
                            class="form-control @error('nama') is-invalid @enderror" id="exampleFormControlInput1"
                            placeholder="Nama">
                        @error('nama')
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" value="{{$kos->telp}}" name="telp"
                            class="form-control @error('telp') is-invalid @enderror" id="exampleFormControlInput1"
                    ...
                    <div class="form-group">
                        <label for="exampleFormControlInput1"><span style="color:red;">*</span> Alamat Kos</label>
                        <input type="text" value="{{$kos->alamat}}"
                            class="form-control @error('alamat') is-invalid @enderror" id="exampleFormControlInput1"
                    ...
                    <div class="form-group">
                        <label for="exampleFormControlTextarea1"><span style="color:red;">*</span> Deskripsi Kos</label>
                    ...
                    <div class="form-group">
                        ...
                        <label for="exampleFormControlInput1"><span style="color:red;">*</span> Gambar Banner</label>
